...
set ipfs_ext "vo"
if {[file exists nco2m.vo]} {
	set hdl_ext "v"
} else {
	puts "Warning: Could not find nco2m.$ipfs_ext!"
}
...
# test bench settings
set_global_assignment -name EDA_DESIGN_INSTANCE_NAME nco2m_inst -section_id tb
set_global_assignment -name EDA_TEST_BENCH_MODULE_NAME work.nco2m_tb -section_id tb

# IPFS file
set_global_assignment -name EDA_IPFS_FILE "nco2m.${ipfs_ext}" -section_id eda_simulation -library work
...
set_global_assignment -name EDA_TEST_BENCH_FILE "nco2m_tb.${hdl_ext}" -section_id tb -library work
